...
//Require XreferenceId for disbursement and making api user
require 'x_reference_disburse1.php';
require 'x_reference_disburse2.php';
...
curl_setopt_array($PaymentStatus, array(
  CURLOPT_URL => 'https://sandbox.momodeveloper.mtn.com/disbursement/v1_0/transfer/'.$UUIDPayment,
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
<body>
  ...
  <form action="<?PHP echo ($_SERVER['PHP_SELF']); ?>";  method="POST">
    <h3>MTN MOMO API</h3>
    <h4>DISBURSEMENTS API</h4>
        <input type="number" name="amount" id="name" placeholder="Enter Amount" ></br>
        <input type="number" name="phone" id="name" placeholder="Enter Payee phone number"></br>
